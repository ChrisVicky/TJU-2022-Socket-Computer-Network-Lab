...
\begin{figure}[htbp!]
    \centering
    \subfigure[Login 成功]{\label{fig:LoginLiso}\includegraphics[width=1.5in]{liso_LoginNow.png}}
    \subfigure[Password 错误]{\label{fig:passwordError}\includegraphics[width=1.8in]{liso_passwordError.png}}
    \caption{测试1}
\end{figure}

...
\begin{figure}[htbp!]
    \centering
    \subfigure[CGI 登陆接口文档]{\includegraphics[width=2in]{CGILogin.png}\label{fig:cgiLogin}}
    \subfigure[CGI 注册接口文档]{\includegraphics[width=2in]{CGIRegister.png}\label{fig:cgiRegister}}
...
\begin{figure}[htbp!]
    \begin{center}
        \includegraphics[width=4.5in]{liso.sh.png}
